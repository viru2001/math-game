...
for (var i = 1; i < 5; i++) {
  document.getElementById("box" + i).onclick = function () {
    ...
    if (playing) {
      ...
      if (this.innerHTML === String(correctAnswer)) {
        //yes
        //play correct sound
...
function getSelectedGame(e) {
  ...
  if (playing) {
    ...
    //if not playing check what is the Game corresponding to the selected Id
